...
const Footer = () => {
  return (
    <div className="bg-black text-white">
      ...
      <div className="flex flex-col md:flex-row bg-black text-white px-6 md:px-[170px] py-4 md:py-[20px] relative gap-4">
      ...
      <div className="px-6 md:px-[230px] flex flex-col md:flex-row justify-between bg-gray-800 py-4 gap-6">
