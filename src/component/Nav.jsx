                  ...
                  <div className={loggedUser?.user?.user?.username ? 'border-b md:pl-4 pl-3 py-2 md:py-4 flex justify-between items-center' : 'text-gray-400 border-b md:pl-4 pl-3 py-2 md:py-4 flex justify-between items-center cursor-not-allowed'}>
                    <div className='flex items-center md:gap-4 gap-3'>
                      ...
                      <div>
                        ...
                        <p className='text-xs font-light'>View all your bookings and purchase</p>
                      </div>
                    </div>
                  ...
                  <div className={loggedUser?.user?.user?.username ? 'border-b md:pl-4 pl-3 py-2 md:py-4 flex justify-between items-center' : 'text-gray-400 border-b md:pl-4 pl-3 py-2 md:py-4 flex justify-between items-center cursor-not-allowed'}>
                    <div className='flex items-center md:gap-4 gap-3'>
                      ...
                      <div>
                        ...
                        <p className='text-xs font-light'>Rented and Purchased Movies</p>
                      </div>
                    </div>
                    <AiOutlineLock className='md:text-lg' />
                  </div>
                  <div className=' z-10 border-b md:pl-4 pl-3 md:py-4 py-2 flex md:justify-between gap-5 items-center hover:bg-gray-100 cursor-pointer'>
                    <div className='flex items-center md:gap-4 gap-3'>
                      ...
                      <div>
                        ...
                        <p className='text-xs font-light line-clamp-1'>View your Play Credit Card details and offers</p>
                      </div>
                    </div>
                    <RxDoubleArrowRight className='' />
                  </div>
