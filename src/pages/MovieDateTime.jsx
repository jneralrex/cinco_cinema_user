  ...
  return (
    <div>
        <div className='mt-[50px] lg:w-[80%] md:mt-[80px] w-[90%] mx-auto'>
            <div>
                <p className='lg:text-[38px] text-[18px] font-semibold pt-5'>Kraven: The Hunter (4DX) - English</p>
            </div>
            <div className='flex lg:gap-2 gap-1 my-2'>
                ...
                <div className='rounded-full text-gray-400 border flex justify-center items-center border-gray-400 lg:px-2 px-1' >
                    <p className='text-center text-gray-400 lg:text-[10px] text-[8px]'>ACTION</p>
                </div>
                <div className='rounded-full text-gray-400 border flex justify-center items-center border-gray-400 lg:px-2 px-1' >
                    <p className='text-center text-gray-400 lg:text-[10px] text-[8px]'>ADVENTURE</p>
                </div>
                <div className='rounded-full text-gray-400 border flex justify-center items-center border-gray-400 lg:px-2 px-1' >
                    <p className='text-center text-gray-400 lg:text-[10px] text-[8px]'>DRAMA</p>
                </div>
            </div>
        </div>
        ...
        <div className='lg:w-[80%] w-[90%] mx-auto block relative lg:flex justify-between mt-5 pb-1'>
            ...
            <div className='hidden lg:flex items-center'>
                <div className='border-l border-r border-b-4 py-5 px-4 border-b-purple-800 flex items-center justify-center gap-2 font-semibold text-sm'>English - 3D <IoIosArrowDown size={15}/></div>
                <div className='border-l border-r py-5 px-4 text-xs font-semibold flex items-center justify-center gap-2'>Filter Price Range <IoIosArrowDown size={15}/></div>
                <div className='border-l border-r py-5 px-4 text-xs font-semibold'>Filter Show Timings</div>
                <div className='border-l border-r py-5 px-4 text-xs font-semibold'><BiSearch className='text-xl text-black/50'/></div>
            </div>
        </div>
        <div className='bg-gray-100 pb-10'>
            <div className='pt-3 lg:w-[80%] w-[90%] mx-auto'>
                            ...
                            <div className='lg:flex gap-3 items-start p-[30px] border-t'>
                                <div className='flex lg:block gap-2'>
                                    ...
                                    <div className='lg:hidden flex w-full justify-between lg:gap-[50px] items-center'>
                                        <p className='text-sm font-semibold mb-4'>Galleria, Victoria Island, Lagos</p>
                    ...
                    <div className='mt-[30px]'>
                        ...
                        <p className=' text-[11px] text-gray-500 mt-3'>By using www.cincocinema.com(our website), you are fully accepting the Privacy Policy
                            available at <span className='underline text-red-400 cursor-pointer'>https://cincocinema.onrender.com/privacy</span> governing your access to cincocinema and provision of
                            services by cincocinema to you. If you do not accept terms mentioned in the <span className='underline text-red-400 cursor-pointer'> Privacy Policy</span>, you must not share
                            any of your personal information and immediately exit cincocinema.
                        </p>
                    </div>
            </div>
        </div>
