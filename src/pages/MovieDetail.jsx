...
const MovieDetail = () => {
    ...
    const singleMovie = async ()=>{
        try {
            const resp = await axios.get(`${import.meta.env.VITE_BASE_URL}movies/${movieId}`);
    ...
    return (
        <div>
            {/* large view */}
            <div 
                className="hidden lg:block relative bg-cover bg-center h-[500px] w-full"
                style={{
                   ...
                   <div className='w-[28%] flex justify-end items-center'>
                    ...
                    <div className='w-[30%] flex justify-center items-center'>
                        <div>
                            ...
                            <div className='bg-zinc-800 rounded-lg p-3 flex items-center justify-between xl:gap-10 mt-5'>
                                <div className='flex gap-2 items-center'>
                                    <FaStar className='text-red-400 text-2xl'/>
                                    <p className='text-white xl:text-lg font-semibold'>7.7/10 (1.4K Votes)</p>
                                </div>
                                <button className='bg-white px-4 py-1 rounded-lg xl:text-lg font-semibold text-center'>
                                    Rate now
                                </button>
                            </div>
