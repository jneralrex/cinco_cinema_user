    ...
    <div className="lg:max-w-7xl  md:px-[100px] mt-14 md:mt-20 lg:mt-0 mx-auto p-5">
      ...
      <div className='fixed bottom-0 right-0 left-0 z-10'>
        ...
        {selectedSeats.length > 0 && (
          <div className="lg:fixed relative p-4 flex items-center justify-center bg-white border-t border-gray-200">
            <button 
              className="w-1/4 text-center items-center justify-center bg-red-500 text-white py-3 rounded-lg font-semibold hover:bg-pink-600 transition-colors md:mx-[300px]"
